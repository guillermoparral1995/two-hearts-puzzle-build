...
const PredictFutureGame = ({ userSelection, sessionId, onGameComplete, onBack }: PredictFutureGameProps) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary to-accent p-4">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-3xl font-bold text-primary">Predict the Future</h1>
        </div>
